    ...
    public class NVehiculo
    {
        ...
        public bool CrearVehiculo(EVehiculo vehiculo, EPropietario propietario)
        {
            try
            {
                ...
                bool resultado = obj_Vehiculo_datos.InsertarVehiculo(vehiculo.placa, vehiculo.valor, vehiculo.año, vehiculo.cilindraje, vehiculo.modelo, vehiculo.color, vehiculo.dni_Propieatrio);
